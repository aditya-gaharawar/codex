...
local_exec_server_port="${WSAI_CODE_REMOTE_EXEC_SERVER_LOCAL_PORT:-8765}"
remote_exec_server_start_timeout_seconds="${WSAI_CODE_REMOTE_EXEC_SERVER_START_TIMEOUT_SECONDS:-15}"
...
remote_codex_rs="$remote_repo_root/wsai-code-rs"
...
printf '  WSAI_CODE_EXEC_SERVER_URL=ws://127.0.0.1:%s codex -C %q\n' \
