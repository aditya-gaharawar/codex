...
//! `EscalateRequest` over the inherited `WSAI_CODE_ESCALATE_SOCKET`, and the server decides whether to
...
//! specified by the `WSAI_CODE_ESCALATE_SOCKET` environment variable to _send_ escalation requests,
