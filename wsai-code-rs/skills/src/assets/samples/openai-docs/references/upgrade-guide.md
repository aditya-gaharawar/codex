...
3. Classify the source model family.
   - Common buckets: GPT-5.4, GPT-5.3-WSAI CODE or GPT-5.2-WSAI CODE, earlier GPT-5.x, GPT-4o or GPT-4.1, reasoning models such as o1 or o3 or o4-mini, third-party model, or mixed and unclear.
