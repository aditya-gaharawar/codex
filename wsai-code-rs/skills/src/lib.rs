...
/// Returns the on-disk cache location for embedded system skills from an absolute WSAI_CODE_HOME.
...
/// Installs embedded system skills into `WSAI_CODE_HOME/skills/.system`.
///
