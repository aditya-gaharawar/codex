...
`codex-otel` is the OpenTelemetry integration crate for WSAI CODE. It provides:
...
let settings = OtelSettings {
    ...
    service_name: "wsai-code-cli".to_string(),
...
that member. If propagated trace context already has the named member, WSAI CODE
...
WSAI CODE-specific session events. Rich session/business events should go through
...
to Statsig using WSAI CODE-internal defaults.
