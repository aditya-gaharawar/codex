...
const PROTECTED_METADATA_WSAI_CODE_PATH_NAME: &str = ".wsai-code";
...
pub const PROTECTED_METADATA_PATH_NAMES: &[&str] = &[
    ...
    PROTECTED_METADATA_WSAI_CODE_PATH_NAME,
];
...
pub fn is_protected_metadata_directory_name(name: &OsStr) -> bool {
    name == OsStr::new(PROTECTED_METADATA_AGENTS_PATH_NAME)
        || name == OsStr::new(PROTECTED_METADATA_WSAI_CODE_PATH_NAME)
}
...
impl FileSystemSandboxPolicy {
    ...
    pub fn workspace_write(
        ...
        append_default_read_only_project_root_subpath_if_no_explicit_rule(&mut entries, ".wsai-code");
    ...
    pub fn get_writable_roots_with_cwd(&self, cwd: &Path) -> Vec<WritableRoot> {
        ...
        .map(|root| {
            ...
            WritableRoot {
                ...
                // `.wsai-code` so downstream sandboxes can still detect and mask
...
pub(crate) fn default_read_only_subpaths_for_writable_root(
    ...
    let top_level_codex = writable_root.join(PROTECTED_METADATA_WSAI_CODE_PATH_NAME);
...
mod tests {
    ...
    #[cfg(unix)]
    const SYMLINKED_TMPDIR_TEST_ENV: &str = "WSAI_CODE_PROTOCOL_TEST_SYMLINKED_TMPDIR";
    ...
    fn writable_roots_proactively_protect_missing_dot_codex() {
        ...
        let expected_dot_codex = expected_root.join(".wsai-code");
    ...
    fn legacy_workspace_write_projection_preserves_symbolic_project_root() {
        ...
        assert_eq!(
            ...
            FileSystemSandboxPolicy::restricted(vec![
                ...
                FileSystemSandboxEntry {
                    path: FileSystemPath::Special {
                        value: FileSystemSpecialPath::project_roots(Some(".wsai-code".into())),
                    },
                    access: FileSystemAccessMode::Read,
                },
            ])
    ...
    fn writable_roots_skip_default_dot_codex_when_explicit_user_rule_exists() {
        ...
        .expect("absolute canonical root");
        let explicit_dot_codex = expected_root.join(".wsai-code");
    ...
    fn filesystem_policy_blocks_protected_metadata_path_writes_by_default() {
        ...
        let dot_codex_config = cwd.path().join(".wsai-code").join("config.toml");
    ...
    fn legacy_workspace_write_projection_accepts_relative_cwd() {
        ...
        assert!(
            !file_system_policy
                .can_write_path_with_cwd(Path::new(".wsai-code/config.toml"), relative_cwd,)
        );
        assert!(
    ...
    fn effective_runtime_roots_preserve_symlinked_paths() {
        ...
        let codex_dir = real_root.join(".wsai-code");
        ...
        let expected_codex = link_root.join(".wsai-code");
    ...
    fn project_roots_special_path_preserves_symlinked_root() {
        ...
        let expected_codex = expected_root.join(".wsai-code");
    ...
    fn writable_roots_preserve_symlinked_protected_subpaths() {
        ...
        let dot_codex = root.join(".wsai-code");
    ...
    fn tmpdir_special_path_preserves_symlinked_tmpdir() {
        ...
        let codex_dir = real_tmpdir.join(".wsai-code");
