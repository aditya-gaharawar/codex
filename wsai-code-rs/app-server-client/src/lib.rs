...
pub struct InProcessClientStartArgs {
    ...
    /// Whether auth loading should honor the `WSAI_CODE_API_KEY` environment variable.
...
mod tests {
    ...
    async fn remote_typed_request_roundtrip_works() {
        ...
        assert_eq!(client.codex_home(), Some("/server/.wsai-code"));
