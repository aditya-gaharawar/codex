...
pub const REFRESH_TOKEN_URL_OVERRIDE_ENV_VAR: &str = "WSAI_CODE_REFRESH_TOKEN_URL_OVERRIDE";
pub const REVOKE_TOKEN_URL_OVERRIDE_ENV_VAR: &str = "WSAI_CODE_REVOKE_TOKEN_URL_OVERRIDE";
pub const CLIENT_ID_OVERRIDE_ENV_VAR: &str = "WSAI_CODE_APP_SERVER_LOGIN_CLIENT_ID";
...
pub const WSAI_CODE_API_KEY_ENV_VAR: &str = "WSAI_CODE_API_KEY";
pub const WSAI_CODE_ACCESS_TOKEN_ENV_VAR: &str = "WSAI_CODE_ACCESS_TOKEN";
...
pub fn read_codex_api_key_from_env() -> Option<String> {
    read_non_empty_env_var(WSAI_CODE_API_KEY_ENV_VAR)
}

pub fn read_codex_access_token_from_env() -> Option<String> {
    read_non_empty_env_var(WSAI_CODE_ACCESS_TOKEN_ENV_VAR)
}
