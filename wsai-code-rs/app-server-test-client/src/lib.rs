...
const TRACE_DISABLED_MESSAGE: &str =
    "Not enabled - enable tracing in $WSAI_CODE_HOME/config.toml to get a trace URL!";
...
struct Cli {
    ...
    #[arg(long, env = "WSAI_CODE_BIN", global = true)]
    ...
    /// `ws://127.0.0.1:4222`.
    #[arg(long, env = "WSAI_CODE_APP_SERVER_URL", global = true)]
    url: Option<String>,
...
enum CliCommand {
    ...
    LiveElicitationTimeoutPause {
        ...
        #[arg(long, env = "WSAI_CODE_E2E_MODEL", default_value = "gpt-5")]
        model: String,
