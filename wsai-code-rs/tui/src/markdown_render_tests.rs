...
fn file_link_hides_destination() {
    let text = render_markdown_text_for_cwd(
        "[wsai-code-rs/tui/src/markdown_render.rs](/Users/example/code/codex/wsai-code-rs/tui/src/markdown_render.rs)",
        Path::new("/Users/example/code/codex"),
    );
    let expected =
        Text::from(Line::from_iter(["wsai-code-rs/tui/src/markdown_render.rs".cyan()]));
    assert_eq!(text, expected);
}
...
fn file_link_appends_line_number_when_label_lacks_it() {
    let text = render_markdown_text_for_cwd(
        "[markdown_render.rs](/Users/example/code/codex/wsai-code-rs/tui/src/markdown_render.rs:74)",
        Path::new("/Users/example/code/codex"),
    );
    let expected = Text::from(Line::from_iter([
        "wsai-code-rs/tui/src/markdown_render.rs:74".cyan(),
    ]));
    assert_eq!(text, expected);
}
...
fn file_link_keeps_absolute_paths_outside_cwd() {
    let text = render_markdown_text_for_cwd(
        ...
        Path::new("/Users/example/code/codex/wsai-code-rs/tui"),
    );
...
fn file_link_appends_hash_anchor_when_label_lacks_it() {
    let text = render_markdown_text_for_cwd(
        "[markdown_render.rs](file:///Users/example/code/codex/wsai-code-rs/tui/src/markdown_render.rs#L74C3)",
        Path::new("/Users/example/code/codex"),
    );
    let expected =
        Text::from(Line::from_iter([
            "wsai-code-rs/tui/src/markdown_render.rs:74:3".cyan(),
        ]));
    assert_eq!(text, expected);
}
...
fn file_link_uses_target_path_for_hash_anchor() {
    let text = render_markdown_text_for_cwd(
        "[markdown_render.rs#L74C3](file:///Users/example/code/codex/wsai-code-rs/tui/src/markdown_render.rs#L74C3)",
        Path::new("/Users/example/code/codex"),
    );
    let expected =
        Text::from(Line::from_iter([
...
fn file_link_appends_range_when_label_lacks_it() {
    let text = render_markdown_text_for_cwd(
        "[markdown_render.rs](/Users/example/code/codex/wsai-code-rs/tui/src/markdown_render.rs:74:3-76:9)",
        Path::new("/Users/example/code/codex"),
    );
    let expected =
        Text::from(Line::from_iter([
            "wsai-code-rs/tui/src/markdown_render.rs:74:3-76:9".cyan(),
        ]));
    assert_eq!(text, expected);
}
...
fn file_link_uses_target_path_for_range() {
    let text = render_markdown_text_for_cwd(
        "[markdown_render.rs:74:3-76:9](/Users/example/code/codex/wsai-code-rs/tui/src/markdown_render.rs:74:3-76:9)",
        Path::new("/Users/example/code/codex"),
    );
    let expected =
        Text::from(Line::from_iter([
...
fn file_link_appends_hash_range_when_label_lacks_it() {
    let text = render_markdown_text_for_cwd(
        "[markdown_render.rs](file:///Users/example/code/codex/wsai-code-rs/tui/src/markdown_render.rs#L74C3-L76C9)",
        Path::new("/Users/example/code/codex"),
    );
    let expected =
        Text::from(Line::from_iter([
...
fn multiline_file_link_label_after_styled_prefix_does_not_panic() {
    let text = render_markdown_text_for_cwd(
        "**bold** plain [foo\nbar](file:///Users/example/code/codex/wsai-code-rs/tui/src/markdown_render.rs#L74C3)",
        Path::new("/Users/example/code/codex"),
    );
    let expected = Text::from(Line::from_iter([
        "bold".bold(),
...
fn file_link_uses_target_path_for_hash_range() {
    let text = render_markdown_text_for_cwd(
        "[markdown_render.rs#L74C3-L76C9](file:///Users/example/code/codex/wsai-code-rs/tui/src/markdown_render.rs#L74C3-L76C9)",
        Path::new("/Users/example/code/codex"),
    );
    let expected =
        Text::from(Line::from_iter([
...
fn markdown_render_file_link_snapshot() {
    let text = render_markdown_text_for_cwd(
        "See [markdown_render.rs:74](/Users/example/code/codex/wsai-code-rs/tui/src/markdown_render.rs:74).",
        Path::new("/Users/example/code/codex"),
    );
    let rendered = text
        .lines
...
fn unordered_list_local_file_link_stays_inline_with_following_text() {
    let text = render_markdown_text_with_width_and_cwd(
        "- [binary](/Users/example/code/codex/wsai-code-rs/README.md:93): core is the agent/business logic, tui is the terminal UI, exec is the headless automation surface, and cli is the top-level multitool binary.",
        Some(72),
    ...
    assert_eq!(
        rendered,
        vec![
            "- wsai-code-rs/README.md:93: core is the agent/business logic, tui is the",
...
fn unordered_list_local_file_link_soft_break_before_colon_stays_inline() {
    let text = render_markdown_text_with_width_and_cwd(
        "- [binary](/Users/example/code/codex/wsai-code-rs/README.md:93)\n  : core is the agent/business logic.",
        Some(72),
        Some(Path::new("/Users/example/code/codex")),
    );
    let rendered = text
    ...
    assert_eq!(
        rendered,
        vec!["- wsai-code-rs/README.md:93: core is the agent/business logic.",]
    );
}
...
fn consecutive_unordered_list_local_file_links_do_not_detach_paths() {
    ...
    assert_eq!(
        rendered,
        vec![
            "- wsai-code-rs/README.md:93: cli is the top-level multitool binary.",
            "- wsai-code-rs/core/README.md:1: codex-core owns the real runtime behavior.",
        ]
    );
}
...
|---|---:|---:|---:|---|
| Suggestion engine and unit coverage | [next_prompt_suggestion.rs](/Users/example/code/codex/wsai-code-rs/core/src/next_prompt_suggestion.rs:1), [next_prompt_suggestion_tests.rs](/Users/example/code/codex/wsai-code-rs/core/src/next_prompt_suggestion_tests.rs:1) | 704 | 0 | Sampling workflow, stable-history checks, tool-flow suppression, fast reasoning profile, filtering rules, cancellation and timeout. |
| Model instruction fragment and contextual isolation | [next_prompt_suggestion.rs](/Users/example/code/codex/wsai-code-rs/core/src/context/next_prompt_suggestion.rs:1), [contextual_user_message_tests.rs](/Users/example/code/codex/wsai-code-rs/core/src/context/contextual_user_message_tests.rs:1) | 54 | 0 | Synthetic suggestion prompt and an isolation test for ordinary user text. |
"#;
    let text = render_markdown_text_with_width_and_cwd(
        md,
        Some(/*width*/ 120),
...
| --- | --- | --- |
| [2026-05-25 current gallery](/Users/felipe.coury/.wsai-code/sessions/2026/05/25/rollout-2026-05-25T18-13-09-019e60fc-0518-7c21-9596-980fe97225ba.jsonl) | The large gallery from this thread: emojis, links, emphasis, code, alignment, paragraphs, and a 30+ row table | 7 |
| [2026-05-14 renderer testing](/Users/felipe.coury/.wsai-code/sessions/2026/05/14/rollout-2026-05-14T12-57-18-019e2734-e500-7011-8278-975c94d06000.jsonl) | Explicit "markdown tables for testing" session with several successive assistant samples | 16 |
| [2026-05-14 five-table test](/Users/felipe.coury/.wsai-code/sessions/2026/05/14/rollout-2026-05-14T12-27-57-019e271a-064c-78c3-a5cd-a6f20a0c1ad5.jsonl) | Explicit request for five tables containing emojis, code, italics, and varied cell content | 10 |
"#;
...
| --- | ---: | ---: | --- |
| [#24485: newline shortcut fails in PyCharm terminal on Windows](https://github.com/wsai/wsai-code/issues/24485) | `+1` 0, substantive comments 0 | Low | New, deterministic regression range; localized composer/keymap path. |
| [#23926: Vim composer `e` stalls at word end](https://github.com/wsai/wsai-code/issues/23926) | `+1` 0, comments 0 | Low | Standing best quick win; deterministic motion bug. |
| [#23651: Zellij scrollback misses Codex transcript over SSH](https://github.com/wsai/wsai-code/issues/23651) | `+1` 3, human comments 2 | Medium | Clear regression and strong scrollback evidence. |
| [#23740: raw ANSI/control sequences in Windows Terminal](https://github.com/wsai/wsai-code/issues/23740) | `+1` 7, human comments 7 | Medium | Highest activity; established Windows rendering regression family. |
| [#24527: typing lag increases with session length](https://github.com/wsai/wsai-code/issues/24527) | `+1` 0, substantive comments 0 | Medium | New TUI-visible performance report; needs profiling before implementation. |
"#;
