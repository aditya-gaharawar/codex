...
pub const WSAI_CODE_EXEC_SERVER_URL_ENV_VAR: &str = "WSAI_CODE_EXEC_SERVER_URL";
pub const WSAI_CODE_EXEC_SERVER_NOISE_REGISTRY_URL_ENV_VAR: &str =
    "WSAI_CODE_EXEC_SERVER_NOISE_REGISTRY_URL";
pub const WSAI_CODE_EXEC_SERVER_NOISE_ENVIRONMENT_ID_ENV_VAR: &str =
    "WSAI_CODE_EXEC_SERVER_NOISE_ENVIRONMENT_ID";
pub const WSAI_CODE_EXEC_SERVER_NOISE_AUTH_TOKEN_ENV_VAR: &str = "WSAI_CODE_EXEC_SERVER_NOISE_AUTH_TOKEN";
pub const WSAI_CODE_EXEC_SERVER_NOISE_CHATGPT_ACCOUNT_ID_ENV_VAR: &str =
    "WSAI_CODE_EXEC_SERVER_NOISE_CHATGPT_ACCOUNT_ID";
...
/// default constructor preserves the legacy `WSAI_CODE_EXEC_SERVER_URL` behavior
/// while configured construction accepts a provider-supplied snapshot.
///
/// Setting `WSAI_CODE_EXEC_SERVER_URL=none` disables environment access by leaving
...
impl EnvironmentManager {
    ...
    /// Builds a manager from `WSAI_CODE_HOME` and local runtime paths used when
    /// creating local filesystem helpers.
    ///
    /// If `WSAI_CODE_HOME/environments.toml` is present, it defines the configured
    /// environments. Otherwise this preserves the legacy
    /// `WSAI_CODE_EXEC_SERVER_URL` behavior.
    ...
    /// reading user config files from `WSAI_CODE_HOME`.
...
-> Result<Option<NoiseRendezvousEnvironmentConfig>, ExecServerError> {
    noise_environment_config_from_values(
        optional_environment_value(WSAI_CODE_EXEC_SERVER_NOISE_REGISTRY_URL_ENV_VAR),
        optional_environment_value(WSAI_CODE_EXEC_SERVER_NOISE_ENVIRONMENT_ID_ENV_VAR),
        optional_environment_value(WSAI_CODE_EXEC_SERVER_NOISE_AUTH_TOKEN_ENV_VAR),
        optional_environment_value(WSAI_CODE_EXEC_SERVER_NOISE_CHATGPT_ACCOUNT_ID_ENV_VAR),
    )
}
        ...
        match (registry_url, environment_id, auth_token) {
            ...
            _ => {
                return Err(ExecServerError::EnvironmentRegistryConfig(format!(
                    "Noise environment requires {WSAI_CODE_EXEC_SERVER_NOISE_REGISTRY_URL_ENV_VAR}, \
{WSAI_CODE_EXEC_SERVER_NOISE_ENVIRONMENT_ID_ENV_VAR}, and \
{WSAI_CODE_EXEC_SERVER_NOISE_AUTH_TOKEN_ENV_VAR}"
                )));
            }
        };
...
impl Environment {
    /// Builds an environment from the raw `WSAI_CODE_EXEC_SERVER_URL` value.
    pub fn create(
        exec_server_url: Option<String>,
        local_runtime_paths: ExecServerRuntimePaths,
    ) -> Result<Self, ExecServerError> {
    ...
    /// Builds an environment from the raw `WSAI_CODE_EXEC_SERVER_URL` value and
