...
//! `~/.wsai-code/config.toml` and normalizes user-entered key specs into canonical
//! forms consumed by runtime keymap resolution in `wsai-code-rs/tui/src/keymap.rs`.
//!
//! Responsibilities:
//!
