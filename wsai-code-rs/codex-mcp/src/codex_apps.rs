...
use crate::mcp::WSAI_CODE_APPS_MCP_SERVER_NAME;
...
impl CodexAppsToolsCacheContext {
    pub(crate) fn tools_cache_path(&self) -> PathBuf {
        self.cache_path_in(WSAI_CODE_APPS_TOOLS_CACHE_DIR)
    }

    pub(crate) fn server_info_cache_path(&self) -> PathBuf {
        self.cache_path_in(WSAI_CODE_APPS_SERVER_INFO_CACHE_DIR)
    }
...
pub(crate) fn normalize_codex_apps_tool_title(
    ...
    if server_name != WSAI_CODE_APPS_MCP_SERVER_NAME {
...
pub(crate) fn load_cached_codex_apps_tools(
    ...
    if cache.schema_version != WSAI_CODE_APPS_TOOLS_CACHE_SCHEMA_VERSION {
...
pub(crate) fn load_cached_codex_apps_server_info(
    ...
    (cache.schema_version == WSAI_CODE_APPS_SERVER_INFO_CACHE_SCHEMA_VERSION)
...
fn write_cached_codex_apps_server_info(
    ...
    let bytes = serde_json::to_vec_pretty(&CodexAppsServerInfoDiskCache {
        schema_version: WSAI_CODE_APPS_SERVER_INFO_CACHE_SCHEMA_VERSION,
...
const WSAI_CODE_APPS_TOOLS_CACHE_DIR: &str = "cache/codex_apps_tools";
pub(crate) const WSAI_CODE_APPS_TOOLS_CACHE_SCHEMA_VERSION: u8 = 4;

const WSAI_CODE_APPS_SERVER_INFO_CACHE_DIR: &str = "cache/codex_apps_server_info";
const WSAI_CODE_APPS_SERVER_INFO_CACHE_SCHEMA_VERSION: u8 = 1;
