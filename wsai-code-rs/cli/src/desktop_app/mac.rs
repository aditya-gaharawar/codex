...
const WSAI_CODE_DMG_URL_ARM64: &str = "https://persistent.oaistatic.com/codex-app-prod/Codex.dmg";
const WSAI_CODE_DMG_URL_X64: &str =
...
pub async fn run_mac_app_open_or_install(
    ...
    let download_url = download_url_override.unwrap_or_else(|| {
        let default_url = if is_apple_silicon_mac() {
            WSAI_CODE_DMG_URL_ARM64
        } else {
            WSAI_CODE_DMG_URL_X64
        };
