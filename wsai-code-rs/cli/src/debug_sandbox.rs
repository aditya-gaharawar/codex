...
#[cfg(target_os = "macos")]
use codex_core::spawn::WSAI_CODE_SANDBOX_ENV_VAR;
use codex_core::spawn::WSAI_CODE_SANDBOX_NETWORK_DISABLED_ENV_VAR;
    ...
    let mut child = match sandbox_type {
        ...
        SandboxType::Seatbelt => {
            ...
            spawn_debug_sandbox_child(
                ...
                env,
                |env_map| {
                    env_map.insert(WSAI_CODE_SANDBOX_ENV_VAR.to_string(), "seatbelt".to_string());
