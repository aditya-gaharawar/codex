...
mod tests {
        ...
        MitmHookConfig {
            ...
            actions: MitmHookActionsConfig {
                ...
                inject_request_headers: vec![InjectedHeaderConfig {
                    ...
                    secret_env_var: Some("WSAI_CODE_GITHUB_TOKEN".to_string()),
                    secret_file: None,
    ...
    fn compile_resolves_env_backed_injected_headers() {
        ...
        let hooks = compile_mitm_hooks_with_resolvers(
            &config,
            |name| (name == "WSAI_CODE_GITHUB_TOKEN").then(|| "ghp-secret".to_string()),
        ...
        assert_eq!(
            ...
            SecretSource::EnvVar("WSAI_CODE_GITHUB_TOKEN".to_string())
        );
        assert_eq!(
