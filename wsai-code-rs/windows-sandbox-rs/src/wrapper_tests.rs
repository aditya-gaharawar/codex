...
use super::WSAI_CODE_HOME_FLAG;
use super::WSAI_CODE_WINDOWS_SANDBOX_ARG1;
...
fn windows_wrapper_args_round_trip() {
    ...
    let args = create_windows_sandbox_command_args_for_permission_profile(
        ...
        Path::new(r"C:\Users\me\.wsai-code"),
    );

    assert_eq!(args[0], WSAI_CODE_WINDOWS_SANDBOX_ARG1);
    assert!(args.contains(&WSAI_CODE_HOME_FLAG.to_string()));
