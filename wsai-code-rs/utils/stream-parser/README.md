...
**Disclaimer**: This code is pretty complex and WSAI CODE did not manage to write it so before updating the code, make
sure to deeply understand it and don't blindly trust WSAI CODE on it. Feel free to update the documentation as you
modify the code
