...
pub const TEST_ENVIRONMENT_ENV_VAR: &str = "WSAI_CODE_TEST_ENVIRONMENT";
pub const LEGACY_REMOTE_ENV_ENV_VAR: &str = "WSAI_CODE_TEST_REMOTE_ENV";
pub const DOCKER_CONTAINER_ENV_VAR: &str = "WSAI_CODE_TEST_REMOTE_ENV_CONTAINER_NAME";
