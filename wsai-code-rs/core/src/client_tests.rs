...
use super::X_WSAI_CODE_INSTALLATION_ID_HEADER;
use super::X_WSAI_CODE_PARENT_THREAD_ID_HEADER;
use super::X_WSAI_CODE_TURN_METADATA_HEADER;
use super::X_WSAI_CODE_WINDOW_ID_HEADER;
...
use codex_model_provider_info::CHATGPT_WSAI_CODE_BASE_URL;
...
fn build_ws_client_metadata_includes_window_lineage_and_turn_metadata() {
    ...
    let turn_metadata: serde_json::Value = serde_json::from_str(
        client_metadata
            .get(X_WSAI_CODE_TURN_METADATA_HEADER)
...
fn model_client_with_counting_attestation(
    ...
    let (auth_manager, provider) = if include_attestation {
        (
            ...
            ModelProviderInfo::create_openai_provider(Some(CHATGPT_WSAI_CODE_BASE_URL.to_string())),
        )
    } else {
        (
            None,
