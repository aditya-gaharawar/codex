...
pub const WSAI_CODE_SANDBOX_NETWORK_DISABLED_ENV_VAR: &str = "WSAI_CODE_SANDBOX_NETWORK_DISABLED";
...
pub const WSAI_CODE_SANDBOX_ENV_VAR: &str = "WSAI_CODE_SANDBOX";
...
/// `WSAI_CODE_SANDBOX_NETWORK_DISABLED_ENV_VAR` environment variable.
...
pub(crate) async fn spawn_child_async(request: SpawnChildRequest<'_>) -> std::io::Result<Child> {
    ...
    if !network_sandbox_policy.is_enabled() {
        cmd.env(WSAI_CODE_SANDBOX_NETWORK_DISABLED_ENV_VAR, "1");
    }
