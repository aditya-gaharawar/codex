...
pub const X_WSAI_CODE_INSTALLATION_ID_HEADER: &str = "x-codex-installation-id";
pub const X_WSAI_CODE_TURN_STATE_HEADER: &str = "x-codex-turn-state";
pub const X_WSAI_CODE_TURN_METADATA_HEADER: &str = "x-codex-turn-metadata";
pub const X_WSAI_CODE_PARENT_THREAD_ID_HEADER: &str = "x-codex-parent-thread-id";
pub const X_WSAI_CODE_WINDOW_ID_HEADER: &str = "x-codex-window-id";
...
const X_WSAI_CODE_WS_STREAM_REQUEST_START_MS_CLIENT_METADATA_KEY: &str =
    "x-codex-ws-stream-request-start-ms";
const WS_REQUEST_HEADER_RESPONSES_LITE_CLIENT_METADATA_KEY: &str =
    "ws_request_header_x_openai_internal_codex_responses_lite";
const RESPONSES_WEBSOCKETS_V2_BETA_HEADER_VALUE: &str = "responses_websockets=2026-02-06";
const X_OPENAI_INTERNAL_WSAI_CODE_RESPONSES_LITE_HEADER: &str =
...
impl ModelClient {
    ...
    pub(crate) async fn compact_conversation_history(
        ...
        if let Ok(header_value) = HeaderValue::from_str(&responses_metadata.installation_id) {
            extra_headers.insert(X_WSAI_CODE_INSTALLATION_ID_HEADER, header_value);
        }
    ...
    async fn stream_responses_websocket(
        ...
        loop {
            ...
            if let Some(turn_state) = self.turn_state.get() {
                client_metadata.insert(X_WSAI_CODE_TURN_STATE_HEADER.to_string(), turn_state.clone());
            }
...
fn stamp_ws_stream_request_start_ms(request: &mut ResponsesWsRequest) {
    ...
    payload
        ...
        .insert(
            X_WSAI_CODE_WS_STREAM_REQUEST_START_MS_CLIENT_METADATA_KEY.to_string(),
...
fn build_responses_headers(
    ...
    {
        headers.insert(X_WSAI_CODE_TURN_STATE_HEADER, header_value);
    }
    headers
}
...
fn add_responses_lite_header(headers: &mut ApiHeaderMap, use_responses_lite: bool) {
    if use_responses_lite {
        headers.insert(
            X_OPENAI_INTERNAL_WSAI_CODE_RESPONSES_LITE_HEADER,
            HeaderValue::from_static("true"),
        );
    }
}
