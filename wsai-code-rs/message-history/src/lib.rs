...
//!
//! The history is stored at `~/.wsai-code/history.jsonl` with **one JSON object per
...
/// Filename that stores the message history inside `~/.wsai-code`.
...
pub async fn append_entry(
    ...
    // Resolve `~/.wsai-code/history.jsonl` and ensure the parent directory exists.
